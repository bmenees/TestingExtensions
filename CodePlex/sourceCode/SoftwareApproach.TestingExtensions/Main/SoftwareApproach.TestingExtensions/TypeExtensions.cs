...
namespace SoftwareApproach.TestingExtensions
{
    public static partial class ExtensionMethods
    {
        ...
        {
            if (source.IsAssignableFrom(comparer))
                AssertHelper.HandleFail("ShouldBeAssignableFrom", message.AppendMessage(Resources.NotAssignableFromString, source, comparer), parameters);
