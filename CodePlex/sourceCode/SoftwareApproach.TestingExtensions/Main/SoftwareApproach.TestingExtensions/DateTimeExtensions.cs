...
namespace SoftwareApproach.TestingExtensions
{
    public static partial class ExtensionMethods
    {
        ...
        {
            if (source >= comparer)
                AssertHelper.HandleFail("ShouldBeBefore", message.AppendMessage(Resources.ActualExpectedString, source, comparer), parameters);
        ...
        {
            if (source > comparer)
                AssertHelper.HandleFail("ShouldBeBeforeOrSameAs", message.AppendMessage(Resources.ActualExpectedString, source, comparer), parameters);
        ...
        {
            if (source <= comparer)
                AssertHelper.HandleFail("ShouldBeAfter", message.AppendMessage(Resources.ActualExpectedString, source, comparer), parameters);
        ...
        {
            if (source < comparer)
                AssertHelper.HandleFail("ShouldBeAfterOrSameAs", message.AppendMessage(Resources.ActualExpectedString, source, comparer), parameters);
