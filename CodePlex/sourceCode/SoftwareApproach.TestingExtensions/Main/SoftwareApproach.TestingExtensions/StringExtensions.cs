...
namespace SoftwareApproach.TestingExtensions
{
    public partial class ExtensionMethods
    {
        ...
        {
            if (String.Compare(source, comparer, true, CultureInfo.CurrentCulture) != 0)
                AssertHelper.HandleFail("ShouldEqualIgnoringCase", message.AppendMessage(Resources.ActualExpectedString, source ?? Resources.NullString, comparer ?? Resources.NullString), parameters);
        ...
        {
            if (String.Compare(source, comparer, true, CultureInfo.CurrentCulture) == 0)
                AssertHelper.HandleFail("ShouldNotEqualIgnoringCase", message.AppendMessage(Resources.ActualExpectedString, source ?? Resources.NullString, comparer ?? Resources.NullString), parameters);
        ...
        public static string ShouldBeEmpty(this string source, string message, params object[] parameters)
        {
            if (source != String.Empty)
                AssertHelper.HandleFail("ShouldBeEmpty", message.AppendMessage(Resources.ActualString, source ?? Resources.NullString), parameters);
        ...
        {
            if (source == String.Empty)
                AssertHelper.HandleFail("ShouldNotBeEmpty", message.AppendMessage(Resources.ActualString, source ?? Resources.NullString), parameters);
        ...
        public static string ShouldContain(this string source, string substring, string message, params object[] parameters)
        {
            if (!source.Contains(substring))
                AssertHelper.HandleFail("ShouldContain", message.AppendMessage(Resources.ActualExpectedContainString, source ?? Resources.NullString, substring ?? Resources.NullString), parameters);
        ...
        {
            if (!source.ToUpper(CultureInfo.CurrentCulture).Contains(substring.ToUpper(CultureInfo.CurrentCulture)))
                AssertHelper.HandleFail("ShouldContainIgnoringCase", message.AppendMessage(Resources.ActualExpectedContainString, source ?? Resources.NullString, substring ?? Resources.NullString), parameters);
        ...
        {
            if (source.Contains(substring))
                AssertHelper.HandleFail("ShouldNotContain", message.AppendMessage(Resources.ActualExpectedContainString, source ?? Resources.NullString, substring ?? Resources.NullString), parameters);
        ...
        {
            if (source.ToUpper(CultureInfo.CurrentCulture).Contains(substring.ToUpper(CultureInfo.CurrentCulture)))
                AssertHelper.HandleFail("ShouldNotContainIgnoringCase", message.AppendMessage(Resources.ActualExpectedContainString, source ?? Resources.NullString, substring ?? Resources.NullString), parameters);
        ...
        public static string ShouldHaveLengthOf(this string source, int length, string message, params object[] parameters)
        {
            if (source.Length != length)
                AssertHelper.HandleFail("ShouldHaveLengthOf", message.AppendMessage(Resources.ActualExpectedString, source != null ? source.Length.ToString() : Resources.NullString, length), parameters);
        ...
        {
            if (source.Length == length)
                AssertHelper.HandleFail("ShouldNotHaveLengthOf", message.AppendMessage(Resources.ActualExpectedString, source != null ? source.Length.ToString() : Resources.NullString, length), parameters);
        ...
        {
            if (source.Length < length)
                AssertHelper.HandleFail("ShouldHaveLengthOfAtLeast", message.AppendMessage(Resources.ActualExpectedString, source != null ? source.Length.ToString() : Resources.NullString, length), parameters);
        ...
        {
            if (source.Length > length)
                AssertHelper.HandleFail("ShouldHaveLengthOfAtMost", message.AppendMessage(Resources.ActualExpectedString, source != null ? source.Length.ToString() : Resources.NullString, length), parameters);
