    ...
    public static partial class ExtensionMethods
    {
        ...
        public static decimal ShouldBeIntegral(this decimal source, string message, params object[] parameters)
        {
            if (source - Math.Truncate(source) != 0)
                AssertHelper.HandleFail("ShouldBeIntegral", message.AppendMessage(Resources.ActualString, source), parameters);
        ...
        {
            if (source - Math.Truncate(source) == 0)
                AssertHelper.HandleFail("ShouldBeFractional", message.AppendMessage(Resources.ActualString, source), parameters);
        ...
        public static decimal ShouldRoundTo(this decimal source, long comparer, string message, params object[] parameters)
        {
            ...
            if (rounded != (decimal)comparer)
                AssertHelper.HandleFail("ShouldRoundTo", message.AppendMessage(Resources.ActualExpectedString, rounded, comparer), parameters);
