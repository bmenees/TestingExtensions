...
namespace SoftwareApproach.TestingExtensions
{
    public static partial class ExtensionMethods
    {
        ...
        {
            if (!Object.Equals(source, comparer))
                AssertHelper.HandleFail("ShouldEqual", message.AppendMessage(Resources.ActualExpectedString, source, comparer), parameters);
        ...
        {
            if (Object.Equals(source, comparer))
                AssertHelper.HandleFail("ShouldNotEqual", message.AppendMessage(Resources.ActualExpectedString, source, comparer), parameters);
        ...
        {
            if (!Object.ReferenceEquals(source, comparer))
                AssertHelper.HandleFail("ShouldBeSameAs", message.AppendMessage(Resources.ActualExpectedString, source, comparer), parameters);
        ...
        {
            if (Object.ReferenceEquals(source, comparer))
                AssertHelper.HandleFail("ShouldNotBeSameAs", message.AppendMessage(Resources.ActualExpectedString, source, comparer), parameters);
