    ...
    public static partial class ExtensionMethods
    {
        ...
        public static IEnumerable<T> ShouldHaveCountOf<T>(this IEnumerable<T> source, int count, string message, params object[] parameters)
        {
            if (source.Count() != count)
                AssertHelper.HandleFail("ShouldHaveCountOf", message.AppendMessage(Resources.ActualExpectedString, source != null ? source.Count().ToString() : Resources.NullString, count), parameters);
        ...
        {
            if (source.Count() == count)
                AssertHelper.HandleFail("ShouldNotHaveCountOf", message.AppendMessage(Resources.ActualExpectedString, source != null ? source.Count().ToString() : Resources.NullString, count), parameters);
        ...
        {
            if (source.Count() < count)
                AssertHelper.HandleFail("ShouldHaveCountOfAtLeast", message.AppendMessage(Resources.ActualExpectedString, source != null ? source.Count().ToString() : Resources.NullString, count), parameters);
