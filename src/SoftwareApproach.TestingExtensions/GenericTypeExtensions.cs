    ...
    public static partial class ExtensionMethods
    {
        ...
        public static T ShouldBeOfType<T>(this T source, Type type, string message, params object[] parameters)
        {
            if (source.GetType() != type)
                AssertHelper.HandleFail("ShouldBeOfType", message.AppendMessage(Resources.ActualExpectedString, source.GetType(), type), parameters);
        ...
        {
            if (source.GetType() == type)
                AssertHelper.HandleFail("ShouldNotBeOfType", message.AppendMessage(Resources.ActualExpectedString, source.GetType(), type), parameters);
